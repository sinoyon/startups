import { Component, Input, ViewChild, NgZone, OnInit, ChangeDetectorRef, ViewRef, Output, EventEmitter } from '@angular/core';
...
import { campaign2htmlData } from '../../common/common';
