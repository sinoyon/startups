...
export class LayoutScrollTopComponent implements OnInit, OnDestroy {
  @HostBinding('class') class = 'scrolltop';
  @HostBinding('style') style = 'bottom: 80px !important; right: 20px !important; border-radius: 50% !important;';
  @HostBinding('id') id = 'kt_scrolltop';
