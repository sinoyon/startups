...
class StickyComponent {
  ...
  // Event API
  public on = (name: string, callBack: Function) => EventHandlerUtil.on(this.element, name, callBack);

  public one = (name: string, callback: Function) => EventHandlerUtil.one(this.element, name, callback);
