...
function isInResponsiveRange(mode) {
  const breakpoint = getViewPort().width;

  if (mode == 'general') {
      return true;
  } else if (mode == 'desktop' && breakpoint >= (+getBreakpoint('lg') + 1)) {
      return true;
  } else if (mode == 'tablet' && (breakpoint >= (+getBreakpoint('md') + 1) && breakpoint < +getBreakpoint('lg'))) {
      return true;
  } else if (mode == 'mobile' && breakpoint <= +getBreakpoint('md')) {
      return true;
  } else if (mode == 'desktop-and-tablet' && breakpoint >= (+getBreakpoint('md') + 1)) {
      return true;
  } else if (mode == 'tablet-and-mobile' && breakpoint <= +getBreakpoint('lg')) {
      return true;
  } else if (mode == 'minimal-desktop-and-below' && breakpoint <= +getBreakpoint('xl')) {
      return true;
  }
